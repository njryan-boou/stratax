...
class Vector:
    ...
    def equal(self, other: "Vector | float") -> BoolVector: ...
    def not_equal(self, other: "Vector | float") -> BoolVector: ...
    def less(self, other: "Vector | float") -> BoolVector: ...
    def less_equal(self, other: "Vector | float") -> BoolVector: ...
    def greater(self, other: "Vector | float") -> BoolVector: ...
    def greater_equal(self, other: "Vector | float") -> BoolVector: ...
    def __eq__(self, other: "Vector | float") -> BoolVector: ...  # type: ignore[override]
    def __ne__(self, other: "Vector | float") -> BoolVector: ...  # type: ignore[override]
    def __lt__(self, other: "Vector | float") -> BoolVector: ...
    def __le__(self, other: "Vector | float") -> BoolVector: ...
    def __gt__(self, other: "Vector | float") -> BoolVector: ...
    def __ge__(self, other: "Vector | float") -> BoolVector: ...
...
class Matrix:
    ...
    def equal(self, other: "Matrix | float") -> BoolMatrix: ...
    def not_equal(self, other: "Matrix | float") -> BoolMatrix: ...
    def less(self, other: "Matrix | float") -> BoolMatrix: ...
    def less_equal(self, other: "Matrix | float") -> BoolMatrix: ...
    def greater(self, other: "Matrix | float") -> BoolMatrix: ...
    def greater_equal(self, other: "Matrix | float") -> BoolMatrix: ...
    def __eq__(self, other: "Matrix | float") -> BoolMatrix: ...  # type: ignore[override]
    def __ne__(self, other: "Matrix | float") -> BoolMatrix: ...  # type: ignore[override]
    def __lt__(self, other: "Matrix | float") -> BoolMatrix: ...
    def __le__(self, other: "Matrix | float") -> BoolMatrix: ...
    def __gt__(self, other: "Matrix | float") -> BoolMatrix: ...
    def __ge__(self, other: "Matrix | float") -> BoolMatrix: ...
...
class Tensor:
    ...
    def equal(self, other: "Tensor | float") -> BoolTensor: ...
    def not_equal(self, other: "Tensor | float") -> BoolTensor: ...
    def less(self, other: "Tensor | float") -> BoolTensor: ...
    def less_equal(self, other: "Tensor | float") -> BoolTensor: ...
    def greater(self, other: "Tensor | float") -> BoolTensor: ...
    def greater_equal(self, other: "Tensor | float") -> BoolTensor: ...
    def __eq__(self, other: "Tensor | float") -> BoolTensor: ...  # type: ignore[override]
    def __ne__(self, other: "Tensor | float") -> BoolTensor: ...  # type: ignore[override]
    def __lt__(self, other: "Tensor | float") -> BoolTensor: ...
    def __le__(self, other: "Tensor | float") -> BoolTensor: ...
    def __gt__(self, other: "Tensor | float") -> BoolTensor: ...
    def __ge__(self, other: "Tensor | float") -> BoolTensor: ...
