/** @file
 * @brief Unchecked offsets from element strides.
 */
#pragma once
 ...
 * the products are summed to produce an element offset from the data pointer.
 *
 * @tparam IndexContainer Iterable container of non-negative indices.
 * @param strides Element strides, either canonical or a view's custom strides.
 ...
 * @pre Every index is valid for the shape associated with @p strides.
